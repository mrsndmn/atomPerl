...
sub test_artist {
    ...
    # решил, что в конце теста буду удалять все сущности созданные
    # это не будет гарантировать, что база останется нетронутой, т к тесты могут упасть в середине -- и ничего не удалится    
    # _________
